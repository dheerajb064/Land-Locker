                ...
                <div className="bodyC">
                    ...
                    <div className="img-wrapper">
                        ...
                        <div className="wine-text-container">
                            <div className="site-title wood-text">Land Locker</div>
                        </div>
                    </div>
                ...
                <div className="auth-wrapper">
                    <div className="auth-inner">
                        <div className="App">
                            ...
                            <div>
                                <div>
                                    <h1 style={{ color: "black" }} style={{ marginLeft: '30px', marginBottom: '10px' }}>
                                        Buyer Registration
                                    </h1>
                                </div>
                            </div>
                            ...
                            <Button onClick={this.RegisterBuyer} className="button-vote" style={{ marginLeft: '100px' }}>
                                Register as Buyer
                            </Button>
